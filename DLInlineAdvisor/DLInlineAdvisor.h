...
public:
  DLInlineAdvisor(Module &M, FunctionAnalysisManager &FAM,
                      LLVMContext &Context,
                      std::unique_ptr<InlineAdvisor> OriginalAdvisor, InlineContext IC);
  

  void onPassEntry(LazyCallGraph::SCC *SCC = nullptr) override {}
  void onPassExit(LazyCallGraph::SCC *SCC = nullptr) override {}
